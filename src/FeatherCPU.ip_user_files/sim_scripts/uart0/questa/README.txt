...
#
# Generated by export_simulation on Mon May 22 15:22:02 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './uart0.sh' script.
...
./uart0.sh -noclean_files

For more information on the script, please type './uart0.sh -help'.
