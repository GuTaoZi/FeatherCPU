...
HD_PWD='C:/Users/jayfe/Desktop/course/DTwo/CO/FeatherCPU/src/FeatherCPU.runs/uart0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart0.tcl
