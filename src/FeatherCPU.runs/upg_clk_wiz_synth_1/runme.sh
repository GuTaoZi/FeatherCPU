...
HD_PWD='C:/Users/jayfe/Desktop/course/DTwo/CO/FeatherCPU/src/FeatherCPU.runs/upg_clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log upg_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source upg_clk_wiz.tcl
