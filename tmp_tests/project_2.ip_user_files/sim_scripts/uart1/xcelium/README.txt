...
#
# Generated by export_simulation on Mon May 22 15:35:01 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './uart1.sh' script.
...
./uart1.sh -noclean_files

For more information on the script, please type './uart1.sh -help'.
